...
tileentitieswind = {"tile", "buttonblock", "flipblock", "platform", "donut", "frozencoin", "tilemoving", "belt", "smallspring", "box", "spring", "screenboundary", "cubedispenser", "ceilblocker", "snakeblock", "powblock", "pbutton", "ice"}
