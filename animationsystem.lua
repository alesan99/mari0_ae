function animationsystem_load()
	...
	if not dcplaying then
		...
		for i = 1, #fl do
			if love.filesystem.getInfo(mappackfolder .. "/" .. mappack .. "/animations/" .. fl[i]) ~= nil then
	...
	for i = 1, #mariocharacter do
		if mariocharacter[i] and (not characterenemiesloaded[mariocharacter[i]]) and love.filesystem.getInfo("alesans_entities/characters/" .. mariocharacter[i] .. "/animations/") ~= nil then
